(function () {
  ...
  angular.module('adopisoft')
    .component('roletaGame', {
      ...
      templateUrl: '/public/plugins/bonus-plugin/views/admin/roleta_game.html'
      ...
      $ctrl.deletePrize = (index) => {
        ...
        $http.post('/bonus-plugin-settings', roleta).then(() => {
